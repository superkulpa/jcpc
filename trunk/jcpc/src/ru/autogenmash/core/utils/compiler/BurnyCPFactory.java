...
public class BurnyCPFactory extends DefaultCPFactory implements ICPListBuilder{
  
  private static final int Precision = 10;
  private static DefaultCPFactory _instance = new BurnyCPFactory();
...
//              }
              ...
              else if (paramName.equals("M"))
              {
                  ...
                  if(value == 21) value = 81;
                  else if(value == 20) value = 83;
